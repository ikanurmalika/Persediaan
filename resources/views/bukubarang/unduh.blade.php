            ...
            <tbody>
                ...
                @foreach($jenisbarang as $jenis)
                    <tr align="left">
                        ...
                        <td colspan="17" style="background-color: lightgreen;"><strong>{{ $jenis->jenis_barang }}</strong></td>
                    </tr>
                    ...
                    @if($perangkat_daerah=='SE-KECAMATAN')
                        ...
                        <tr align="left">
                            ...
                            <td colspan="17" style="background-color: lightblue;"><strong>{{ $perangkat_daerah }}</strong></td>
                        </tr>
